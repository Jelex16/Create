...
class OfferingAtendidosScreen extends StatefulWidget {
  const OfferingAtendidosScreen({super.key, required this.listOffering});
  final List<OfferCreateModel> listOffering;

  @override
  State<OfferingAtendidosScreen> createState() => _OfferingAtendidosScreen();
}

class _OfferingAtendidosScreen extends State<OfferingAtendidosScreen> {
  @override
        ...
        body: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return CardThingMarchListAtendidos(
